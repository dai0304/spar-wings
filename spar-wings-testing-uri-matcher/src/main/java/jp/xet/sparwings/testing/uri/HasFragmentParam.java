...
public class HasFragmentParam extends TypeSafeMatcher<URI> {
	...
	public void describeTo(Description mismatchDescription) {
		if (matcher == null) {
			mismatchDescription.appendText("fragment has ").appendValue(name).appendText(" parameter");
		} else {
			mismatchDescription.appendText("fragment parameter ").appendValue(name)
